...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_community_categories_name'), 'community_categories', ['name'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_community_categories_name'), table_name='community_categories')
